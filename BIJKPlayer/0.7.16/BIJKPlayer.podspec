...
Pod::Spec.new do |spec|
  ...
  spec.author       = { "tg" => "developer@transcodegroup.com" }
  ...
  spec.homepage     = "https://github.com/TranscodeGroup/ijkplayer"
  ...
  spec.source = { :http => "https://github.com/TranscodeGroup/ijkplayer/releases/download/f0.7.16/IJKMediaPlayer.tar.gz" }
